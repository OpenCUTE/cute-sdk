...
#include "golden/manual/vector/fuse_dequant_rope_bf16cvt_m64_n64/golden_fuse_dequant_rope_bf16cvt.h"
...
int main(void)
{
    const cute_rope_ctx_t ctx = {
        .pos = GOLDEN_FUSE_ROPE_POS,
        .rope_theta = golden_fuse_rope_theta,
        .key_dim = GOLDEN_FUSE_N,
    };

    cute_fuse_dequant_rope_bf16cvt_tile(golden_fuse_input_i32,
