/**
 * Tensor-level tiled matmul test with CPU memcpy post_op and two-buffer pipeline.
 * CUTE writes each 64x64 tile to alternating scratch buffers while CPU copies the previous tile.
