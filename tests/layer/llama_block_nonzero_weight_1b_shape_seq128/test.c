...
#define TEST_EMBED_DIM 2048
#define TEST_KEY_DIM 64
#define TEST_VALUE_DIM 64
#define TEST_N_HEAD_Q 32
#define TEST_N_HEAD_KV 8
#define TEST_FFN_DIM 8192
#define TEST_MAX_CTX_LEN 8192
...
int main(void)
{
    cute_llama_block_config_t cfg = {
        ...
        .proj_q_weight = golden_llama_proj_q_weight,
        .proj_q_weight_scale = golden_llama_proj_q_scale,
        .proj_k_weight = golden_llama_proj_k_weight,
